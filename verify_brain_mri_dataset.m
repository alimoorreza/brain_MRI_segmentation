% ------------ CLEAN DIRECTORIES --------------
src_path         = '/Users/reza/Downloads/Brain_MRI/MRI_dataset_cleaned/';
...
function copy_correct_files(src_path, dst_path, split_name)
    ...
    mask_files                    = dir([src_path '/' split_name '/masks/*.png']);
    ...
    for ii=1:total_files
        ...
        if ismember([cur_image_name], mask_files_cell_array)
            ...
            copyfile([src_path  '/' split_name  '/masks/' cur_image_name], [dst_path '/' split_name '/masks/'], 'f');
    ...
    disp([num2str(counter_missing-1) '/' num2str(total_files) ' were missing']);
